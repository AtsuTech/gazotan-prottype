    ...
    return (
        <div className="flex justify-between stiky top-0 z-50 flex w-full h-20 bg-amber-400 text-gray-300">
            <h1 className="flex text-white ml-2 font-light" role="APP名">
                <span className="text-4xl text-white">Gazotan</span>
                <ul className="flex">
                    <li className="m-2">
                        <NavLink to="/about" activeClassName="active" className="block w-20 h-12 mt-4 p-1 ml-2 text-center text-gray-600">
                            about
                        </NavLink>
                    </li>
                    <li className="m-2">
